...
def post_register(request: Request,
    ...
    return templates.TemplateResponse(request=request, name="register.html", context={"request": request, "error": error, "login": login, "date_b": date_b, "fio": fio, "email": email, "phone": phone})
...
def post_login(request: Request,
    ...
    if login == "Admin26":
        if password == "Demo20":
            ...
            return templates.TemplateResponse(request=request, name="login.html", context={"request": request, "error": "Неверные данные"})
...
def get_profile(request: Request):
    ...
    return templates.TemplateResponse(request=request, name="profile.html", context={"request": request, "requests": requests_list})
...
def get_create_request(request: Request):
    ...
    return templates.TemplateResponse(request=request, name="create_request.html", context={"request": request, "transports": TRANSPORTS, "payments": PAYMENTS})
