...
COURSES = ["Алгоритмы", "База данных", "Оригами"]
...
def get_admin(request: Request):
    ...
    with get_db() as conn:
        requests_list = conn.execute("select requests.*, users.login, users.fio from users,requests where requests.user_id = users.id").fetchall()
